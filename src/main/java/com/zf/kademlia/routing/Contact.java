...
public class Contact implements Serializable {
	...
	public Contact(byte[] id, String ip, int port) {
		this.id = id;
		this.ip = ip;
		this.port = port;
	}
	...
	public byte[] distance(Contact other) {
	...
	public static Contact createNode(String ip, int port) {
